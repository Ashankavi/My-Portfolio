...
const Navbar = () => {
    ...
    return (
        <div className='flex max-w-auto font-bold px-4 text-white bg-[#000000] relative'>
            ...
            <div className={nav ? 'fixed left-0 top-0 w-[30%] h-full border-r border-r-gray-900 bg-[#000000] ease-in-out duration-500 z-50' : 'fixed left-[-100%] z-50'}>
                <img className='h-[60px] m-8' src={Logo} alt="Logo" />
                <h1 className='w-full text-3xl font-bold text-[#00df9a] m-4'> </h1>
                <ul className='tracking-wide uppercase font-londrina'>
